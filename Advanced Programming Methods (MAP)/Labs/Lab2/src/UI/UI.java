...
public class UI {
    ...
    private void addPacient() throws DuplicateObjectException {
    ...
    private void addProgramare() throws DuplicateObjectException, ObjectNotFoundException {
    ...
    private void deletePacient() throws ObjectNotFoundException {
        int id = readId();
        service.deletePacient(id);
    }

    private void deleteProgramare() throws ObjectNotFoundException {
        int id = readId();
        service.deleteProgramare(id);
    }

    private void updatePacient() throws ObjectNotFoundException {
        Scanner scn = new Scanner(System.in);
    ...
    private void updateProgramare() throws ObjectNotFoundException {
        Scanner scn = new Scanner(System.in);
        System.out.print("ID Programare: ");
        int id = scn.nextInt();
    ...
    private void add() throws DuplicateObjectException, ObjectNotFoundException {
        Scanner scn = new Scanner(System.in);
        System.out.print("""
                1. Pacient \s
                2. Programare \n""");
    ...
    private void delete() throws ObjectNotFoundException {
        Scanner scn = new Scanner(System.in);
        System.out.print("""
                1. Pacient \s
                2. Programare \n""");
    ...
    private void update() throws ObjectNotFoundException {
        Scanner scn = new Scanner(System.in);
        System.out.print("""
                1. Pacient \s
                2. Programare \n""");
